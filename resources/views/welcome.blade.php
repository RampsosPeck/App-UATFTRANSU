...
<html lang="es">
  <head> 
    ...
    <meta name="csrf-token" content="hvp0zvPLqdXg5ACwLc30rDlUmI6JFaHnKYdlCXVH">

    <title>Uatftrans</title>

    <!-- Bootstrap core CSS 
    <link href="vlaz/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet"> -->
    ...
    <link href="vlaz/css/business-casual.css" rel="stylesheet">
  ...
  <body>
    ...
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      ...
      <span class="site-heading-lower">SISTEMA DE TRANSPORTE UNIVERSITARIO</span>
      <span class="site-heading-upper text-primary mb-3">UATFTRANS</span>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        <a class="navbar-brand text-uppercase text-expanded font-weight-bold d-lg-none" href="#"> UATFTRANS </a>
                  ...
                  <a class="nav-link text-uppercase text-expanded" href="/">WEB
                    <span class="sr-only">(current)</span>
                      ...
                      <li class="nav-item  px-lg-4">
                        <a class="nav-link text-uppercase text-expanded" href="http://uatftrans.edu/login">INGRESAR</a>
                      </li>
                       
                         <!--  <li class="nav-item  px-lg-4">
                           <a class="nav-link text-uppercase text-expanded" href="http://uatftrans.edu/register"> REGISTRARSE </a> 
                          </li>-->
                                                        
             

            <li class="nav-item  px-lg-4">
                <a class="nav-link text-uppercase text-expanded" href="http://uatftrans.edu/map">RUTA</a>
            </li>
            <li class="nav-item  px-lg-4">
                <a class="nav-link text-uppercase text-expanded" href="http://uatftrans.edu/clock">HORARIOS</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section class="page-section clearfix">
      <div class="container">  
                        <div class="intro">
                <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="/img/logines.jpg" alt="">
                <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                  ...
                  <div class="intro-button mx-auto">
                    <a class="btn btn-primary btn-xl" href="http://uatftrans.edu/login">Ingresa ya..!</a>
                  </div>
                </div>
              </div>
                </div>
        ...
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              ...
              <p class="mb-0  text-justify"> Es brindar a los estudiantes, docentes y administrativos de la <strong>"UNIVERSIDAD TOMÁS FRÍAS"</strong> la facilidad de trasladarse de manera rápida a la ciudadela universitaria desde el edificio central y viceversa. Con la finalidad de la obtención de un sistema de transporte eficiente, seguro, y ambientalmente amigable bajo los criterios de sostenibilidad y responsabilidad.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="footer text-faded text-center py-5">
      <div class="container"> 
        <p class="m-0 small"> &copy; {{ date('Y') }} . Created by ING. JORGE PERALTA</p>
      </div>
    </footer>

    <!-- Bootstrap core JavaScript 
    <script src="vlaz/vendor/jquery/jquery.min.js"></script> -->
